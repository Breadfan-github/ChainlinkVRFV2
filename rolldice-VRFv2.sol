...
//DONT FORGET TO APPROVE CONSUMER FROM SUBSCRIPTION MANAGER WITH YOUR ID

//visit https://docs.chain.link/docs/intermediates-tutorial/ for full explainantion

/* request randomness from Chainlink VRF. 
The result of the randomness will transform into a number between 1 and 20, 
mimicking the rolling of a 20 sided die. Each number represents a Game of Thrones house. 
If the dice lands on the value 1, the user is assigned house Targaryan, 2 for Lannister, and so on. 
*/
/**
